...
class Download {
	...
	public function stream_content() {
		...
		if ( function_exists( 'set_time_limit' )
		     && ! in_array( 'set_time_limit', explode( ',', ini_get( 'disable_functions' ) ) )
		     && ! ini_get( 'safe_mode' ) ) {
			@set_time_limit( 0 );
		}
	 ...
	 * @throws \Exception
	 */
	public static function instance( $file, $is_stream = false, $mimetype = 'default', $proxy = false ) {

		if ( is_null( self::$instance ) ) {
			self::$instance = new self( $file, $is_stream, $mimetype, $proxy );
		}
